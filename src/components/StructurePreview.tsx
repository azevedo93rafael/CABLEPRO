...
export function StructurePreview({ structure, cables, allCables, packedCables, fillPercentage, limit, index, allowedArea, onCableClick, onNameChange, viewMode = 'cross', t, darkMode, zoom = 1, showLimitLine = true }: StructurePreviewProps) {
  ...
  if (isIso) {
    return (
      <motion.div 
        ...
        className={`relative flex flex-col items-center shrink-0 w-[500px] rounded-3xl p-4 transition-all ${isOverLimit ? 'ring-4 ring-[#E63946]/20 bg-[#E63946]/5' : ''}`}
      >
        {renderHeader()}
